...
function RoomContent(){
 ...
 if(room)return <AppFrame back="/lobby"><div style={{maxWidth:900,margin:"0 auto"}}>
  ...
  <div style={{marginTop:18,padding:18,borderRadius:18,background:"linear-gradient(135deg,#071c45,#0b1630)",border:"1px solid rgba(59,130,246,.22)"}}><div style={{fontWeight:900,fontSize:18}}>🎙️ Live room</div><p style={{color:"#94a3b8",marginBottom:0}}>Players who are waiting can now discover this room in Online Players. Voice chat and quick messages work across devices.</p></div>
