...
export default function LobbyPage(){
 ...
 return <AppFrame><div style={{maxWidth:900,margin:"0 auto",paddingBottom:40}}>
  ...
  <section style={freeSection}><div style={{display:"flex",justifyContent:"space-between",gap:16,alignItems:"center",flexWrap:"wrap"}}><div><div style={freeLabel}>🎮 FREE PLAY</div><h2 style={{margin:"5px 0 4px",fontSize:26}}>Play without coins</h2><p style={{margin:0,color:"#a7f3d0",fontSize:13}}>A completely free Ludo mode with no stakes or paid rooms.</p></div><button onClick={()=>openRoom("/free-play")} style={freeButton}>PLAY FREE →</button></div><div style={{display:"flex",gap:10,flexWrap:"wrap",marginTop:16,color:"#86efac",fontSize:12,fontWeight:800}}><span>✓ Free</span><span>✓ No stakes</span><span>✓ Live multiplayer</span><span>✓ Same Ludo rules</span></div></section>
