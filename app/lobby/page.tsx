...
export default function LobbyPage(){
 ...
 return <AppFrame hideBack><div style={{maxWidth:900,margin:"0 auto",paddingBottom:40}}>
  ...
  <div style={flow}><b>Live matchmaking</b><br/><span>Create Room → Players agree through voice/chat → Host sets the agreed stake in the room → Players stake → Ready → Stakes lock → Host starts → Winner receives the full pot</span></div>
