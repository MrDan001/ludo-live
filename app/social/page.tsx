...
function SocialContent(){
 ...
 const create=()=>{if(!socket||!connected)return;pendingRef.current="create";socket.emit("create-chat-room",{title:title.trim()||`${name}'s Chat`,name});setTitle("")};
 const join=(roomCode:string)=>{if(!socket)return;pendingRef.current="join";socket.emit("join-chat-room",{roomCode,name})};
