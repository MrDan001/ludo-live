  ...
  return (
    <div className="xp-celebration" role="status" aria-live="polite" onAnimationEnd={(e) => {
      ...
      <style jsx>{`
        ...
        .xp-reward{margin:13px 0 10px;padding:10px 12px;border-radius:14px;background:rgba(250,204,21,.09);border:1px solid rgba(250,204,21,.28);animation:xp-fade 1s 1.75s both}
        .xp-reward-title{font-size:10px;letter-spacing:2px;font-weight:950;color:#facc15}.xp-reward-items{display:flex;flex-wrap:wrap;justify-content:center;gap:8px;margin-top:7px}.xp-reward-items span{padding:6px 9px;border-radius:9px;background:rgba(255,255,255,.07);font-size:11px;font-weight:900;color:#fff}
