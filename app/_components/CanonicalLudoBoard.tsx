...
export default function CanonicalLudoBoard({theme="classic",demoTokens=[],onTokenClick}:Props){
 ...
 return <div className="canonical-ludo-frame" style={{position:"relative",width:"100%",aspectRatio:"1",borderRadius:17}} aria-label={`${BOARD_NAMES[theme]} canonical Ludo board`}>
