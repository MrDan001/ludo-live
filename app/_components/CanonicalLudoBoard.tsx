...
export default function CanonicalLudoBoard({theme="classic",demoTokens=[],onTokenClick}:Props){
 ...
 return <div className="canonical-ludo-frame" style={{position:"relative",width:"100%",aspectRatio:"1",outline:`3px solid ${BOARD_PALETTES[theme].accent}`,outlineOffset:"10px",borderRadius:17}} aria-label={`${BOARD_NAMES[theme]} canonical Ludo board`}>
  <style>{`.canonical-ludo-frame .shared-ludo-board{box-shadow:none!important}`}</style>
