...
async function setup(){
  ...
  // PostgreSQL folds unquoted identifiers to lowercase. The catalog JSON uses
  // camelCase rewardCoins/rewardGems, so quote those aliases explicitly or the
  // seed INSERT receives NULL rewards and the NOT NULL constraint rejects it.
