  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        /* /game-online: single responsive layout model. */
        ...
        /* Long/narrow phones: reserve the header and HUD, then make the board consume every
           remaining pixel.  No board height is hard-coded here. */
        @media (orientation: portrait) and (max-width: 900px) and (max-aspect-ratio: 1 / 2) {
          .ludo-live-wrapper .ludo-live-container {
            padding: 8px 4px 6px !important;
            grid-template-rows: 88px minmax(0, 1fr) 218px !important;
            gap: 0 !important;
          }
          ...
          /* The board stage is allowed to use the full phone width, including the 4px
             container breathing room.  The square therefore grows to the true available width. */
          .ludo-live-wrapper .ll-board-stage {
          ...
          .ludo-live-wrapper .ll-controls-row {
            ...
            grid-template-columns: minmax(104px, .78fr) minmax(0, 1.5fr) 52px !important;
            gap: 5px !important;
          }
          ...
          /* Dice: do not scale the cube down. Give it a real slot and shrink only the
             surrounding button footprint so the complete 78px cube fits on narrow phones. */
          .ludo-live-wrapper .ll-dice-box {
            display: grid !important;
          ...
          .ludo-live-wrapper .ll-dice-slot .dice-button {
            width: 92px !important;
            height: 92px !important;
          }
          .ludo-live-wrapper .ll-dice-slot .dice-value { font-size: 15px !important; }
          .ludo-live-wrapper .ll-dice-slot .dice-hint { width: 92px !important; font-size: 7px !important; white-space: nowrap !important; text-align: center !important; }
