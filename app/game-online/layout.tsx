  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* Long/narrow phones: the board owns every pixel left between header and HUD. */
        @media (orientation: portrait) and (max-width: 900px) and (max-aspect-ratio: 1 / 2) {
          ...
          .ludo-live-wrapper .multiplayer-player-card-opponent .multiplayer-level-badge:only-child { display: none !important; }
          .ludo-live-wrapper .multiplayer-player-card-opponent:has(.multiplayer-player-status) .multiplayer-level-badge { display: none !important; }
          ...
          /* Dice gets a bounded column. The visual cube is scaled from its own center, never clipped by the card. */
          .ludo-live-wrapper .ll-dice-box {
            display: grid !important;
          ...
          .ludo-live-wrapper .ll-dice-slot :global(.dice-area) {
