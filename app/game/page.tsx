  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setSkinId(equipped);
        setTheme(resolveTheme(equipped));
        try {
    ...
    >
      ...
      <div className="game-content">
        <header className="skin-header">
          <div className="skin-header-icon" aria-hidden="true">
            {header.icon}
          </div>
      ...
      <style jsx global>{`
        * {
        ...
        .skin-header {
          ...
          gap: 18px;
          padding: 18px 20px;
          border: 1px solid color-mix(in srgb, var(--skin-accent) 65%, white 35%);
          border-radius: 30px;
          background: linear-gradient(
            135deg,
            color-mix(in srgb, var(--skin-bg) 78%, white 22%),
            color-mix(in srgb, var(--skin-accent) 16%, var(--skin-bg) 84%)
          );
          box-shadow:
            var(--skin-shadow),
            0 20px 46px color-mix(in srgb, var(--skin-accent) 18%, transparent);
        ...
        .skin-header:before {
          ...
          box-shadow:
            ...
            inset 0 -1px 0 color-mix(in srgb, var(--skin-accent) 28%, transparent);
          z-index: -1;
        }
        .skin-header:after {
          content: "";
        ...
        .skin-header-icon {
          ...
          place-items: center;
          border-radius: 24px;
          border: 2px solid color-mix(in srgb, var(--skin-accent) 72%, white 28%);
          background: linear-gradient(
            145deg,
            color-mix(in srgb, white 26%, transparent),
            color-mix(in srgb, var(--skin-accent) 12%, transparent)
          );
          font-size: 40px;
          box-shadow:
            inset 0 2px 12px color-mix(in srgb, white 32%, transparent),
            0 10px 26px color-mix(in srgb, var(--skin-accent) 18%, transparent);
        }
        .skin-header-copy {
          position: relative;
          z-index: 1;
        ...
        .skin-eyebrow {
          ...
          font-weight: 950;
          letter-spacing: 3px;
          color: color-mix(in srgb, var(--skin-accent) 72%, white 28%);
        }
        .skin-title {
          margin-top: 5px;
          font-size: 24px;
          ...
          color: color-mix(in srgb, var(--skin-accent) 32%, var(--skin-bg) 68%);
          text-shadow: 0 3px 16px color-mix(in srgb, var(--skin-accent) 20%, transparent);
        }
        .skin-subtitle {
          margin-top: 9px;
          font-size: 12px;
          color: color-mix(in srgb, var(--skin-bg) 28%, white 72%);
          white-space: nowrap;
          overflow: hidden;
        ...
        .live-pill {
          ...
          padding: 11px 15px;
          border-radius: 999px;
          border: 1px solid color-mix(in srgb, white 42%, var(--skin-accent) 58%);
          background: color-mix(in srgb, var(--skin-accent) 14%, transparent);
          color: color-mix(in srgb, var(--skin-bg) 22%, white 78%);
          font-weight: 950;
          letter-spacing: 1px;
          font-size: 11px;
          box-shadow:
            inset 0 1px 0 color-mix(in srgb, white 22%, transparent),
            0 7px 18px color-mix(in srgb, var(--skin-accent) 16%, transparent);
        }
        .live-pill span,
        .live-match span {
          width: 100px;
          ...
          border-radius: 50%;
          background: color-mix(in srgb, var(--skin-accent) 78%, white 22%);
          box-shadow: 0 0 14px color-mix(in srgb, var(--skin-accent) 52%, transparent);
        }
        .live-match {
          display: flex;
          ...
          letter-spacing: 4px;
          font-size: 15px;
          color: color-mix(in srgb, var(--skin-bg) 24%, white 76%);
          text-shadow: 0 2px 12px color-mix(in srgb, var(--skin-accent) 24%, transparent);
        }
        .board-host {
          position: relative;
          z-index: 1;
        ...
        .board-host section[aria-label="Dice and turn controls"] {
