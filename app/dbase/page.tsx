...
const sections = [
  ["Overview","Dashboard","/dbase","⌂"], ["Players","Players","/dbase/players","♟"], ["Economy","Economy","/dbase/economy","◈"], ["Analytics","Visitors","/dbase/visitors","◒"], ["Moderation","Disputes","/dbase/disputes","⚑"], ["Moderation","Audit Log","/dbase/audit","◷"], ["Catalogue","Shop","/dbase/shop","▣"], ["Catalogue","Boards","/dbase/boards","▤"], ["Catalogue","Dice","/dbase/dice","◆"], ["Catalogue","Avatars","/dbase/avatars","●"], ["Catalogue","Yards","/dbase/yards","▧"], ["Rewards","Spin Wheel","/dbase/spin","✦"], ["Live Ops","Missions","/dbase/missions","✓"], ["Live Ops","Events","/dbase/events","◇"], ["Live Ops","Tournament","/dbase/tournament","♛"], ["Finance","Finance","/dbase/finance","₦"], ["Support","Support","/dbase/support","?"],
] as const;
  ...
  return <div className="dbase-app">
    ...
    <div className="dbase-main">
      ...
      <main className="dbase-content">
        ...
        <section className="quick-grid"><Link href="/dbase/shop"><b>Shop catalogue</b><span>Prices, currencies, rarity and level locks</span><em>→</em></Link><Link href="/dbase/spin"><b>Spin Wheel</b><span>Rewards, weights and eligible Shop items</span><em>→</em></Link><Link href="/dbase/yards"><b>Yard assets</b><span>Backgrounds and backgroundless artwork</span><em>→</em></Link><Link href="/dbase/support"><b>Support</b><span>Player cases and admin replies</span><em>→</em></Link></section>
