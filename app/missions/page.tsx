...
const targetBadge={width:42,height:42,borderRadius:12,display:"grid",placeItems:"center",background:"#0d2345",border:"1px solid #244a7d",fontSize:22};
const tabs={display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:5,padding:5,borderRadius:12,background:"#07162d",border:"1px solid #17345d"};
const tab={border:0,borderRadius:8,padding:"10px 5px",fontSize:12,fontWeight:900,cursor:"pointer"};
const missionList={display:"grid",gap:8,marginTop:14};
const mission={padding:"12px 13px",borderRadius:12,background:"linear-gradient(145deg,#071a35,#061124)",border:"1px solid #17345d"};
const status={flex:"0 0 27px",width:27,height:27,borderRadius:"50%",display:"grid",placeItems:"center",color:"#fff",fontWeight:950};
const rowTop={display:"flex",justifyContent:"space-between",gap:8,fontSize:13};
const progressTrack={height:7,borderRadius:99,background:"#122641",overflow:"hidden",marginTop:8};
const progressBar={height:"100%",borderRadius:99,transition:"width .3s"};
const rowBottom={display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:7,fontSize:11,color:"#8fa2bd"};
const claimBtn={border:0,borderRadius:8,padding:"6px 15px",background:"#5fcf27",color:"#092006",fontWeight:950,cursor:"pointer"};
const claimAllBtn={width:"100%",marginTop:14,border:0,borderRadius:9,padding:"12px",background:"linear-gradient(180deg,#4edc22,#2b9d13)",color:"#fff",fontWeight:950,fontSize:15,cursor:"pointer"};
const empty={marginTop:14,padding:40,background:"#07162d",borderRadius:14,textAlign:"center" as const,color:"#9fb0c9"};
const messageBox={marginTop:12,padding:11,borderRadius:10,background:"#07331a",border:"1px solid #1c8d4c",color:"#7ff0a8",fontSize:12};
