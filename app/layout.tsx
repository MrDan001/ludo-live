...
import PwaClientGate from "./_components/PwaClientGate";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="en"><body>
    ...
    <Suspense fallback={null}><GameSocialOverlay /></Suspense>
    <Suspense fallback={null}><LudoAudio /></Suspense>
    <XPLevelCelebration /><XPWinWatcher /><ActiveSpinRewards /><MissionGameplayTracker />
    <NotificationGate /><SuspendedGate /><PlayerNotificationPopup /><AdminPlayerModeration />
  </body></html>;
}
