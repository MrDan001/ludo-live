...
import AdminQATestButton from "./_components/AdminQATestButton";
...
export default function RootLayout({children}:{children:React.ReactNode}){
  return <html lang="en"><body><ServiceWorkerRegistration /><SessionResume /><Suspense fallback={null}><AppShell>{children}</AppShell></Suspense><Suspense fallback={null}><GameSocialOverlay /></Suspense><Suspense fallback={null}><LudoAudio /></Suspense><AdminQATestButton /></body></html>;
}
