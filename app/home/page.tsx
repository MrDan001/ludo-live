...
const shortcuts = [
  { href: "/rewards", icon: "🎁", label: "Daily Reward" }, { href: "/shop", icon: "🛒", label: "Shop" },
  { href: "/rewards", icon: "📅", label: "Events" }, { href: "/shop", icon: "🎯", label: "Spin Wheel" },
];
