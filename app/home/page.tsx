...
const actions: Action[] = [
  ...
  { icon: "🎯", title: "MISSIONS", sub: "Complete missions and earn rewards", href: "/missions", bg: "linear-gradient(135deg,#b86b12,#e39a24)" },
];
  ...
  return (
    <main style={page}>
      <div style={shell}>
        ...
        <Link href="/rewards" style={{ ...streakStyle, color: "inherit", textDecoration: "none" }}><div style={{ minWidth: 0 }}><b style={{ display: "block", color: "#ffd21a", fontSize: "clamp(12px,3vw,16px)" }}>🔥 DAILY STREAK</b><span style={{ display: "block", marginTop: 3, color: "#a9bddb", fontSize: "clamp(9px,2.5vw,13px)", whiteSpace: "nowrap" }}>Keep playing to unlock bigger rewards.</span></div><span style={{ border: 0, borderRadius: 12, padding: "11px clamp(13px,3.5vw,20px)", background: "#ffd21a", color: "#111", fontWeight: 950, fontSize: "clamp(10px,2.7vw,14px)" }}>CLAIM</span></Link>
      </div>
