export const BOARDS = [
  ...
  { id: "golden", name: "Golden Royal", currency: "gems", price: 50, rarity: "EPIC", imageUrl: "/api/shop/board-preview/golden" },
  { id: "neon", name: "Neon Glow", currency: "gems", price: 100, rarity: "LEGENDARY", imageUrl: "/api/shop/board-preview/neon" },
  { id: "beach", name: "Beach Vibes", currency: "coins", price: 3000, rarity: "RARE", imageUrl: "/api/shop/board-preview/beach" },
  { id: "galaxy", name: "Galaxy Space", currency: "gems", price: 75, rarity: "EPIC", imageUrl: "/api/shop/board-preview/galaxy" },
  { id: "wood", name: "Wooden Classic", currency: "coins", price: 1000, rarity: "COMMON", imageUrl: "/api/shop/board-preview/wood" },
  { id: "dragon", name: "Dragon Theme", currency: "gems", price: 80, rarity: "EPIC", imageUrl: "/api/shop/board-preview/dragon" },
  { id: "christmas", name: "Christmas Edition", currency: "coins", price: 3500, rarity: "RARE", imageUrl: "/api/shop/board-preview/christmas" },
  { id: "football", name: "Football Arena", currency: "gems", price: 70, rarity: "EPIC", imageUrl: "/api/shop/board-preview/football" },
  { id: "candy", name: "Candy Land", currency: "gems", price: 120, rarity: "LEGENDARY", imageUrl: "/api/shop/board-preview/candy" },
  { id: "marble", name: "Marble Luxe", currency: "coins", price: 1000, rarity: "LEGENDARY", imageUrl: "/api/shop/board-preview/marble" },
  { id: "nature", name: "Nature Wood", currency: "coins", price: 600, rarity: "EPIC", imageUrl: "/api/shop/board-preview/nature" },
  { id: "space", name: "Space Galaxy", currency: "coins", price: 1200, rarity: "LEGENDARY", imageUrl: "/api/shop/board-preview/space" },
  { id: "crystal", name: "Crystal Ice", currency: "coins", price: 900, rarity: "EPIC", imageUrl: "/api/shop/board-preview/crystal" },
  { id: "fireice", name: "Fire & Ice", currency: "coins", price: 1500, rarity: "LEGENDARY", imageUrl: "/api/shop/board-preview/fireice" },
  { id: "jungle", name: "Jungle Quest", currency: "coins", price: 700, rarity: "EPIC", imageUrl: "/api/shop/board-preview/jungle" },
  { id: "love", name: "Love Edition", currency: "coins", price: 800, rarity: "EPIC", imageUrl: "/api/shop/board-preview/love" },
  { id: "night", name: "Night City", currency: "coins", price: 1000, rarity: "LEGENDARY", imageUrl: "/api/shop/board-preview/night" },
  { id: "arabian", name: "Arabian Palace", currency: "coins", price: 1300, rarity: "LEGENDARY", imageUrl: "/api/shop/board-preview/arabian" },
  { id: "midnight-live", name: "Midnight Live", currency: "gems", price: 130, rarity: "LEGENDARY", imageUrl: "/api/shop/board-preview/midnight-live" },
] as const;
