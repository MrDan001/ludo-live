...
export const AVATARS = [
  ...
  { id: "premium-01", name: "Royal Sentinel", icon: "atlas:01", currency: "gems", price: 2500, rarity: "PREMIUM" },
  { id: "premium-02", name: "Shadow Strategist", icon: "atlas:02", currency: "gems", price: 2800, rarity: "PREMIUM" },
  { id: "premium-03", name: "Crown Commander", icon: "atlas:03", currency: "gems", price: 3000, rarity: "PREMIUM" },
  { id: "premium-04", name: "Iron Regent", icon: "atlas:04", currency: "gems", price: 3200, rarity: "PREMIUM" },
  { id: "premium-05", name: "Neon Marshal", icon: "atlas:05", currency: "gems", price: 3500, rarity: "PREMIUM" },
  { id: "premium-06", name: "Frost Vanguard", icon: "atlas:06", currency: "gems", price: 3800, rarity: "PREMIUM" },
  { id: "premium-07", name: "Ember Commander", icon: "atlas:07", currency: "gems", price: 4200, rarity: "PREMIUM" },
  { id: "premium-08", name: "Midnight Captain", icon: "atlas:08", currency: "gems", price: 4500, rarity: "PREMIUM" },
  { id: "premium-09", name: "Silver Sovereign", icon: "atlas:09", currency: "gems", price: 5000, rarity: "PREMIUM" },
  { id: "premium-10", name: "Crimson Officer", icon: "atlas:10", currency: "gems", price: 5500, rarity: "PREMIUM" },
  { id: "elite-01", name: "Azure Warden", icon: "atlas:11", currency: "gems", price: 7000, rarity: "ELITE" },
  { id: "elite-02", name: "Obsidian Regent", icon: "atlas:12", currency: "gems", price: 7500, rarity: "ELITE" },
  { id: "elite-03", name: "Golden Diplomat", icon: "atlas:13", currency: "gems", price: 8000, rarity: "ELITE" },
  { id: "elite-04", name: "Storm Commander", icon: "atlas:14", currency: "gems", price: 8500, rarity: "ELITE" },
  { id: "elite-05", name: "Emerald Guardian", icon: "atlas:15", currency: "gems", price: 9000, rarity: "ELITE" },
  { id: "elite-06", name: "Platinum Strategist", icon: "atlas:16", currency: "gems", price: 9500, rarity: "ELITE" },
  { id: "elite-07", name: "Violet Chancellor", icon: "atlas:17", currency: "gems", price: 10000, rarity: "ELITE" },
  { id: "elite-08", name: "Titan Executive", icon: "atlas:18", currency: "gems", price: 11000, rarity: "ELITE" },
  { id: "elite-09", name: "Sapphire Marshal", icon: "atlas:19", currency: "gems", price: 12000, rarity: "ELITE" },
  { id: "elite-10", name: "Onyx Director", icon: "atlas:20", currency: "gems", price: 13000, rarity: "ELITE" },
  { id: "elite-11", name: "Solar Commander", icon: "atlas:21", currency: "gems", price: 14000, rarity: "ELITE" },
  { id: "elite-12", name: "Arctic Sovereign", icon: "atlas:22", currency: "gems", price: 15000, rarity: "ELITE" },
  { id: "elite-13", name: "Carbon Warden", icon: "atlas:23", currency: "gems", price: 16000, rarity: "ELITE" },
  { id: "elite-14", name: "Royal Envoy", icon: "atlas:24", currency: "gems", price: 17000, rarity: "ELITE" },
  { id: "elite-15", name: "Phantom Director", icon: "atlas:25", currency: "gems", price: 18000, rarity: "ELITE" },
  { id: "elite-16", name: "Cyber Regent", icon: "atlas:26", currency: "gems", price: 19000, rarity: "ELITE" },
  { id: "elite-17", name: "Crimson Chancellor", icon: "atlas:27", currency: "gems", price: 20000, rarity: "ELITE" },
  { id: "elite-18", name: "Aegis Commander", icon: "atlas:28", currency: "gems", price: 22000, rarity: "ELITE" },
  { id: "elite-19", name: "Noir Strategist", icon: "atlas:29", currency: "gems", price: 24000, rarity: "ELITE" },
  { id: "elite-20", name: "Imperial Vanguard", icon: "atlas:30", currency: "gems", price: 26000, rarity: "ELITE" },
] as const;
